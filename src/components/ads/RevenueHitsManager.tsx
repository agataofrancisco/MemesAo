      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center space-x-2">
            ...
            <span>RevenueHits Analytics Detalhados</span>
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          {/* Mapa de posicionamento dos anúncios */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
              Mapa de Posicionamento dos 6 Anúncios
            </h4>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    Posição: Topo da página, antes do header
                  </p>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <p className="text-sm text-green-700 dark:text-green-300">
                    Posição: Após Hero, antes de Top Memes
                  </p>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <p className="text-sm text-green-700 dark:text-green-300">
                    Posição: Após Top Memes, antes de Statistics
                  </p>
                  <p className="text-sm text-green-600 dark:text-green-400">
                    CPM: $5-10
                  </p>
              ...
              <div className="space-y-4">
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <p className="text-sm text-green-700 dark:text-green-300">
                    Posição: Após Featured Memes, antes de Categories
                  </p>
                  <p className="text-sm text-green-600 dark:text-green-400">
                    CPM: $5-10
                  </p>
                ...
                <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg border border-orange-200 dark:border-orange-800">
                  ...
                  <p className="text-sm text-orange-700 dark:text-orange-300">
                    Posição: Lateral direita, ao lado de Features
                  </p>
