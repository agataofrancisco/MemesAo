        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Faça parte da maior comunidade de memes de Angola! Compartilhe os
              seus memes favoritos e ajude outros a encontrarem o conteúdo
              perfeito para o seu estado. Chega de horas a procurar por um meme.
            </p>
          </motion.div>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-white/80">
                Milhares de usuários compartilhando diariamente
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white/80">
                Sistema de moderação garante os melhores memes
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white/80">
                Upload instantâneo com categorização automática
              </p>
            </div>
          </motion.div>
